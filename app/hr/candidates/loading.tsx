...
export default function Loading() {
  return (
    <main aria-busy="true" aria-label="HR aday havuzu yükleniyor" className="employer-dashboard-theme mx-auto w-full max-w-[1440px] flex-1 p-4 md:p-8" role="status">
      ...
      <span className="sr-only">HR aday havuzu yükleniyor...</span>
    </main>
  );
}
