...
export default function Loading() {
  return (
    <EmployerShell>
      <main aria-busy="true" aria-label="İşveren yardım merkezi yükleniyor" className="mx-auto w-full max-w-[1440px] flex-1 p-4 md:p-8" role="status">
        ...
        <span className="sr-only">İşveren yardım merkezi yükleniyor...</span>
      </main>
    </EmployerShell>
  );
}
