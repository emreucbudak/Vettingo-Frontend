...
export default function Loading() {
  return (
    <EmployerShell>
      <main aria-busy="true" aria-label="Başvuru detayı yükleniyor" className="candidate-analysis-theme mx-auto w-full max-w-[1440px] flex-1 p-4 md:p-8" role="status">
        ...
        <span className="sr-only">Başvuru detayı yükleniyor...</span>
      </main>
    </EmployerShell>
  );
}
