  ...
  return (
    <CandidateShell>
      <main aria-busy="true" aria-label="Aday ayarları yükleniyor" className="mx-auto w-full max-w-[1440px] flex-1 p-4 md:p-8" role="status">
        <header className="mb-8 flex flex-col gap-5 border-b border-[#c5c6cd] pb-7 lg:flex-row lg:items-end lg:justify-between"><Skeleton className="h-10 w-48" /><Skeleton className="h-10 w-32" /></header>
